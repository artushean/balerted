...
- **Legacy local prototype:** `stock_alerts/` + `docs/` can still run against local API for development.

## Frontend integration

`docs/app.js` is now integrated for both environments:
...
- FE JSON mirror for root static docs: `docs/latest_data.json`
